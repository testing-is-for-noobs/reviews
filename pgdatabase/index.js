...
// const insertReview = (review, res) => {
//     console.log('inserting reviews');
//     const query = 'INSERT INTO review100 (rid, pid, user_name, age_range,create_date, review_title, recommendationYN, purchased_for,rating,review,upvotes,downvotes,play_experience, difficulty_level, money_value, build_hrs, build_mins, building_experience) VALUES (100001, 1, "Adaline_Hyatt84", "19-24","2020-7-3 ", "User-friendly needs-based knowledge base", "N", "Son",4,"oluptatem quaerat ipsam eos accusantium sed quam. Accusantium sit quia expedita perspiciatis sapiente exercitationem",0,0,2, 3, "null", "null", 19, "null") RETURNING *';
//     // const reviewData = [
//     //     review.rid,
//     //     review.pid,
//     //     review.user_name,
